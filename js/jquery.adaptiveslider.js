...
(function($) {
	...
	$.fn.adaptiveSlider = function(options) {
		...
		$slider.prepend('<li unselectable class="slider-nav next"><i class="icon fa fa-angle-right" aria-hidden="true"></i></li>');
		$slider.prepend('<li unselectable class="slider-nav prev"><i class="icon fa fa-angle-left" aria-hidden="true"></i></li>');
