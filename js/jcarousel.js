...
$.fn.jCarouselLite = function(o) {
	o = $.extend({
		...
		hoverPause: true,	// При наведении на элемент галереи останавливается автоматическая прокрутка [false - не останавливать, true - останавливать]
		mouseWheel: false,	// Включает прокрутку колесиком мышки, необходим mousewheel.js [false - выключено, true - включено]

		speed: 0,		// Скорость пролистывания [1сек = 1000]
